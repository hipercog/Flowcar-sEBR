...
The skill-demand$\times$PI.2 LMM predicting sEBR showed the interaction was significant (df = 37, t = -3.680, p $<$ 0.01). %NHST7
...
%%%%%%%%%%%%%%%%%%%%%%%%     DISCUSSION    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Discussion}
\todo[inline,author=BC]{EVERYTHING THAT FOLLOWS COMES FROM OUR FIRST ARTICLE AND MUST BE UPDATED...}
...
% sEBR was of interest in our reinforcement-based learning task (positive reinforcement from increase in speed, negative reinforcement from collisions
