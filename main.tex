...
sEBR showed a negative relationship to participant-wise LC slopes, as shown in Fig.~\ref{fig:EBRvLC}, panel A. The correlation is of moderate strength, though non-significant (Pearson's {\it r} = -.46 , {\it p} = 1.0, N = 9). %NHST13
...
Mean Flow scores are not related to sEBR (Pearson's {\it r} = 0.15, {\it p} = 1.0, N = 9). %NHST14
